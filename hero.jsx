...
export default function Hero() {
  const skills = ['UI/UX Designer', 'Frontend Developer', 'Backend Developer', 'Creative Coder','Full Stack Web Developer',];
  const greetings = ["Hello", "Hii", "Belli",];
      ...
      <div className="relative z-20 flex items-center justify-center w-full h-full p-8 text-center bg-black/20 pointer-events-none sm:p-16 md:p-24">
        <div className="max-w-md pointer-events-auto">
          ...
          <div className="flex justify-center gap-4 mt-8">
            ...
            <a
              href="https://drive.google.com/file/d/1WPtIZD97T8Z1coKkcFhBKkWPROyBm_HP/view?usp=drivesdk"
              target="_blank"
