          ...
          >
            ...
            >
              <div className="flex items-center">
                ...
                <span className="ml-1 text-black lg:inline p-1">Star on Naukri</span>
              </div>
              <div className="ml-2 flex items-center gap-1 text-sm md:flex">
                ...
                <span className="inline-block tabular-nums tracking-wider font-display font-medium text-black dark:text-black">
                  {stars !== null ? stars : "--"}
                </span>
              </div>
            </button>
