...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/pratheek-hn73', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/pratheekHN', icon: ICONS.GitHub },
  { name: 'X', url: 'https://www.linkedin.com/in/pratheek-hn73', icon: ICONS.Twitter },
  { name: 'Mail', url: 'mailto:pratheek2552@gmail.com', icon: ICONS.Mail },
];
