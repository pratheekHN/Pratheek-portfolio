...
const projectData = [
    {
        title: 'Transaction Fraud Detection Using Machine Learning Approach',
        description: 'It is the main project in Engineering which is implemented using the Machine learning algorithms.',
        // Use your Cloudinary video URL here:
        videoUrl: 'https://www.youtube.com/watch?v=BRaAU2vAG_c',
        imageUrl: project1Img, // optional fallback
        liveUrl: 'https://www.youtube.com/watch?v=BRaAU2vAG_c',
        repoUrl: '#',
        tags: ['Random Forrest', 'Logistic Regression', 'svm', 'Python'],
    },
    {
        ...
        liveUrl: 'https://www.youtube.com/watch?v=waCkrUIlSTo',
        repoUrl: 'https://www.youtube.com/watch?v=waCkrUIlSTo',
